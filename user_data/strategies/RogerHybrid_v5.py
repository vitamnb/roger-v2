"""
Roger Hybrid Strategy v5 - Frequency
RSI40: RSI40/30, vol1.2, RR2.0, age50
Expectancy: $5.33, 48.4% win, 31 trades/6mo
"""
...
class RogerHybrid_v5(IStrategy):
    timeframe = '1h'
    stoploss = -0.02
    trailing_stop = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for i in range(1, len(dataframe)):
            ...
            if rsi_cross and ob_zone and vol_spike:
                ...
                dataframe.loc[dataframe.index[i], 'enter_tag'] = f'v5_freq|ob_low={ob_low:.4f}'
        return dataframe

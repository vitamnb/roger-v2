"""
Roger Hybrid Strategy v4 - Volume Confirmation
VOL2.0x: RSI35/30, vol2.0, RR2.0, age50
Expectancy: $8.91, 60% win, 15 trades/6mo
"""
...
class RogerHybrid_v4(IStrategy):
    timeframe = '1h'
    stoploss = -0.02
    trailing_stop = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for i in range(1, len(dataframe)):
            ...
            if rsi_cross and ob_zone and vol_spike:
                ...
                dataframe.loc[dataframe.index[i], 'enter_tag'] = f'v4_vol2x|ob_low={ob_low:.4f}'
        return dataframe

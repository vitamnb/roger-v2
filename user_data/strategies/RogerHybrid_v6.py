"""
Roger Hybrid Strategy v6 - Workhorse
AGE30: RSI35/30, vol1.2, RR2.0, age30 (fresher blocks)
Expectancy: $5.07, 50% win, 54 trades/6mo, best return +27.4%
"""
...
class RogerHybrid_v6(IStrategy):
    timeframe = '1h'
    stoploss = -0.02
    trailing_stop = False
    ...
    rsi_oversold = 30
    volume_mult = 1.2
    order_block_lookback = 30  # Fresher blocks only
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        for i in range(1, len(dataframe)):
            ...
            if rsi_cross and ob_zone and vol_spike:
                ...
                dataframe.loc[dataframe.index[i], 'enter_tag'] = f'v6_workhorse|ob_low={ob_low:.4f}'
        return dataframe
